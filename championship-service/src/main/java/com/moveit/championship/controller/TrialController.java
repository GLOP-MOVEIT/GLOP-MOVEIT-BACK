...
public class TrialController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Manche récupérée avec succès", content = @Content(schema = @Schema(implementation = TrialDTO.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Manche créée avec succès", content = @Content(schema = @Schema(implementation = TrialDTO.class))),
    ...
    public ResponseEntity<TrialDTO> createTrial(@PathVariable Integer competitionId, @Valid @RequestBody TrialRequestDTO dto) {
        Trial trial = competitionMapper.toTrialEntity(dto);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Manche mise à jour avec succès", content = @Content(schema = @Schema(implementation = TrialDTO.class))),
            @ApiResponse(responseCode = "400", description = "Données invalides", content = @Content()),
            @ApiResponse(responseCode = "403", description = "Accès refusé - Rôle Admin requis", content = @Content()),
            @ApiResponse(responseCode = "404", description = "Manche non trouvée", content = @Content()),
            @ApiResponse(responseCode = "500", description = "Erreur interne du serveur", content = @Content())
